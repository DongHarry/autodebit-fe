<template>
    <div class="container-layout">
      <div class="container-layout__header">
        <Breadcrumb :paths="title.BREADCRUMB_SETTING_PROVINCE.value">
      ...
      <div class="container-layout__content">
        ...
        <div>
        <DrawerProvince ref="drawerProvinceRef" @reload="reload" />
  ...
  import { createColumns } from '~/utils/tableColumns/provinceTableColumns'
  import { list } from '~/api/provinces'
  import DrawerProvince from '~/components/provinces/DrawerProvince.vue'
  
  const title = useTitle()
  
  const searchInput = ref()
  const provinceTableColumns = createColumns(searchInput)
  const drawerProvinceRef = ref<InstanceType<typeof DrawerProvince>>()
...
const handleCreate = () => {
  drawerProvinceRef.value?.showDrawer()
}
  </script>
