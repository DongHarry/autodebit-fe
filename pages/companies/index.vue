...
import { createColumns } from '~/utils/tableColumns/companyTableColumns'
import DrawerCompany from '~/components/companies/DrawerCompany.vue'
...
const refDrawerCompany = ref()
const companyTableColumns = createColumns(searchInput)
type Key = string | number

const { dataSource, pagination, loading, handleTableChange, reload } =
  useTablePagination({
    apiGetList: listCompany,
...
const openDrawer = () => {
  refDrawerCompany.value.showDrawer()
}

const openEditDrawer = (company: Object) => {
  refDrawerCompany.value.showDrawer(company)
}

const savedCompany = () => {
  reload()
  refDrawerCompany.value.closeDrawer()
}
...
const rowSelection: TableProps['rowSelection'] = {
  ...
  getCheckboxProps: (record: ICompany) => ({
...
<template>
  <div class="container-layout">
    <div class="container-layout__header">
      <Breadcrumb :paths="title.BREADCRUMB_SETTING_COMPANY.value">
    ...
    <div class="container-layout__content">
      <div class="flex items-center mb-3">
        ...
        <a-button v-show="hasSelected" class="ml-3" danger>Xóa</a-button>
      </div>
      <a-table
        :columns="companyTableColumns"
    ...
    <DrawerCompany ref="refDrawerCompany" @saved="savedCompany" />
  </div>
</template>
