<template>
  <div class="container-layout">
    <div class="container-layout__header">
      <Breadcrumb :paths="title.BREADCRUMB_SETTING_CARRIER.value">
    ...
    <div class="container-layout__content">
      ...
      <div>
        <DrawerCarrier ref="drawerCarrierRef" @reload="reload" />
      </div>
    </div>
  </div>
</template>
...
import { createColumns } from '~/utils/tableColumns/carrierTableColumns'
...
const carrierTableColumns = createColumns(searchInput)
...
const handleCreate = () => {
  drawerCarrierRef.value?.showDrawer()
}

const editCarrier = (record: Object) => {
  drawerCarrierRef.value?.showDrawer(record)
}

const handleDelete = async () => {
  try {
    const response = await remove({ data: toRaw(state.selectedRowKeys)})
